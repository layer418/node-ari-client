...
Resource.prototype.removeListener = function (event, callback) {
  ...
  if (listeners[event]) {
    var updatedListeners = listeners[event].filter(function(listener) {
      return listener.id !== id || listener.callback !== callback;
    });
    var instanceListeners = listeners[event].filter(function(listener) {
      return listener.id === id && listener.callback === callback;
    });
    ...
    function callSwagger (/* args..., callback */) {
      ...
      var promise = new Promise(function(resolve, reject) {
        ...
        params.forEach(function (param) {
          ...
          if (Array.isArray(actualParam)) {
            actualParam = actualParam.find(function (candidate) {
        ...
        // generated id.
        if (Object.keys(self._createMethods || {}).includes(operation)) {
        ...
        function processResponse (response) {
          ...
          if (knownTypes.includes(respType) &&
